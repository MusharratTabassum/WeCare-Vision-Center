        ...
        <div className='container mt-5'>
            <div className='d-flex'>
                <div className='col-lg-9 '>
                    <h1 className='mb-4'>WeCare Vision Center</h1>
                    <div className='history mt-2'>
                        <p>Opening its doors in August 2006 and situated beside the picturesque Gulshan Lake, this hospital is one of the largest private sector healthcare facilities in Bangladesh. United Hospital has the capacity to house over 500 patients and has 12 state of the art operation theatres to cater to the needs of varied patient base.</p>
